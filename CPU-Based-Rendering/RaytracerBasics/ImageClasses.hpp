...
class ImageWriter {
public:
	virtual void writeData(std::string& filename, Image& img, int colorDepth, float gamma = 2.2f) = 0;	
};
...
public:
	...
	void writeData(std::string& filename, Image& img, int colorDepth, float gamma);
